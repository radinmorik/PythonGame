...
# Load images
dead_tree = pygame.image.load("dead_tree.png")  # Replace with correct file name
full_tree = pygame.image.load("full_tree.png")  # Replace with correct file name
leaf_images = [
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if len(leaves) < max_leaves:
                for _ in range(100):  # Try multiple times to find a valid position
